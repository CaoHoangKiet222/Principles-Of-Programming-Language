...
class BKOOLParser ( Parser ):
    ...
    class ExpContext(ParserRuleContext):
        ...
        def term(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(BKOOLParser.TermContext)
            else:
                return self.getTypedRuleContext(BKOOLParser.TermContext,i)
    ...
    class TermContext(ParserRuleContext):
        ...
        def factor(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(BKOOLParser.FactorContext)
            else:
                return self.getTypedRuleContext(BKOOLParser.FactorContext,i)


        def COMPARE(self):
            return self.getToken(BKOOLParser.COMPARE, 0)
    ...
    def term(self):
        ...
        localctx = BKOOLParser.TermContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.factor()
                self.state = 24
                self.match(BKOOLParser.COMPARE)
                self.state = 25
                self.factor()
                pass
    ...
    class FactorContext(ParserRuleContext):
        ...
        def operand(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(BKOOLParser.OperandContext)
            else:
                return self.getTypedRuleContext(BKOOLParser.OperandContext,i)


        def ANDOR(self, i:int=None):
            if i is None:
                return self.getTokens(BKOOLParser.ANDOR)
            else:
                return self.getToken(BKOOLParser.ANDOR, i)
    ...
    def factor(self):
        ...
        try:
            ...
            while _la==BKOOLParser.ANDOR:
                self.state = 31
                self.match(BKOOLParser.ANDOR)
                self.state = 32
                self.operand()
                self.state = 37
                self._errHandler.sync(self)
