...
class BKOOLParser (Parser):
    ...
    class FactorContext(ParserRuleContext):
        ...
        def ANDOR(self):
            return self.getToken(BKOOLParser.ANDOR, 0)
    ...
    def factor(self, _p: int = 0):
        ...
        localctx = BKOOLParser.FactorContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 6
        ...
        try:
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    _prevctx = localctx
                    localctx = BKOOLParser.FactorContext(
                        self, _parentctx, _parentState)
                    self.pushNewRecursionContext(
                        localctx, _startState, self.RULE_factor)
                    self.state = 30
