...
4"""
    ...
    """
        expect = "10.010.010.010.010.010.010.010.010.0"
    ...
    def test_80(self):
        input = """
        checkzero: function boolean(nums: array[10] of integer, size: integer) {
          found: boolean = false;
        ...
        main: function void() {
            n : integer = 5;
            arr: array[5] of integer = {1, 31, 23, 4324, 234};
            if (checkzero(arr, n))
                printString("arr has a zero");
            else
                printString("zero doesn't contain in arr");
        }
    """
        expect = "zero doesn't contain in arr"
    ...
    def test_83(self):
        input = """
        min_two_nums: function integer (a: integer, b: integer) {
            if (a < b) {
                return a;
            }
            return b;
    ...
    def test_87(self):
        ...
        main: function void() {
            printInteger(gcdIteration(12, 6));
        }
    """
        expect = "6"
    ...
    def test_100(self):
        ...
        main: function void() {
            printInteger(gcdRecursion(12, 6));
        }
    """
        expect = "6"
