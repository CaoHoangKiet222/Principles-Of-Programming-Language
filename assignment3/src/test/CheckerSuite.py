...
class CheckerSuite(unittest.TestCase):
    ...
    def test_1(self):
        input = """
            ...
            x: integer = a + 2;
            """
        expect = "Type mismatch in Variable Declaration: VarDecl(x, IntegerType, BinExpr(+, Id(a), IntegerLit(2)))"
    ...
    def test_9(self):
        ...
        """
        expect = "Type mismatch in Variable Declaration: VarDecl(e, ArrayType([2, 3], IntegerType), ArrayLit([ArrayLit([FloatLit(1.0)]), ArrayLit([IntegerLit(1), IntegerLit(2), IntegerLit(3)])]))"
    ...
    def test_11(self):
        input = """
            ...
            """
        expect = "Type mismatch in Variable Declaration: VarDecl(b, ArrayType([2, 3], IntegerType), ArrayLit([ArrayLit([FloatLit(1.0)]), ArrayLit([FloatLit(1.0), FloatLit(3.0), FloatLit(4.0)])]))"
    ...
    def test_15(self):
        input = """
            ...
            """
        expect = "Type mismatch in Variable Declaration: VarDecl(d, ArrayType([2, 3], BooleanType), ArrayLit([ArrayLit([BooleanLit(False), BooleanLit(False)]), ArrayLit([IntegerLit(1)])]))"
    ...
    def test_16(self):
        input = """
            ...
            """
        expect = "Type mismatch in Variable Declaration: VarDecl(e, ArrayType([2, 3], BooleanType), ArrayLit([BooleanLit(False), BooleanLit(True), BooleanLit(True)]))"
    ...
    def test_35(self):
        ...
        """
        expect = "Type mismatch in Variable Declaration: VarDecl(y, BooleanType, UnExpr(-, FuncCall(inc, [Id(x), IntegerLit(1)])))"
    ...
    def test_54(self):
        input = """
            ...
            foo1: function integer (x: integer) inherit foo {
                super(1, 1);
                return 1;
            }
            """
    ...
    def test_69(self):
        ...
        """
        expect = "Type mismatch in Variable Declaration: VarDecl(k, IntegerType, Id(x))"
...
"""
    ...
    def test_110(self):
        input = r"""
        foo1: function integer(inherit y: integer, inherit x: float){}

        main: function void(){
            x: integer = readInteger();
            //printInteger(foo1(10, 1));// -> Type mismatch in expression: FuncCall(foo1, [IntegerLit(10), IntegerLit(1)])
            printInteger(foo1(1)); //-> Type mismatch in expression: FuncCall(foo1, [])
        }
    """
        expect = "Type mismatch in expression: FuncCall(foo1, [IntegerLit(1)])"
    ...
    def test_111(self):
        ...
        expect = "Type mismatch in expression: FuncCall(foo1, [IntegerLit(10), IntegerLit(1)])"
